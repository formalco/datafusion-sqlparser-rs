...
use crate::ast::{
    AccessExpr, Action, AddDropSync, AfterMatchSkip, AlterColumnOperation, AlterConnectorOwner,
    AlterIndexOperation, AlterPolicyOperation, AlterRoleOperation, AlterTableAlgorithm,
    AlterTableLock, AlterTableOperation, AlterType, AlterTypeAddValue, AlterTypeAddValuePosition,
    AlterTypeOperation, AlterTypeRename, AlterTypeRenameValue, AnalyzeFormat, ArgMode, Array,
    ArrayElemTypeDef, Assignment, AssignmentTarget, AttachDuckDBDatabaseOption, AttachedToken,
    BeginTransactionKind, BinaryLength, BinaryOperator, CascadeOption, CaseStatement, CaseWhen,
    CastFormat, CastKind, CeilFloorKind, CharLengthUnits, CharacterLength, CloseCursor,
    ClusteredBy, ClusteredIndex, ColumnDef, ColumnOption, ColumnOptionDef, ColumnPolicy,
    ColumnPolicyProperty, CommentDef, CommentObject, ConditionalStatementBlock,
    ConditionalStatements, ConflictTarget, ConnectByKind, ConstraintCharacteristics,
    ContextModifier, CopyIntoSnowflakeKind, CopyLegacyCsvOption, CopyLegacyOption, CopyOption,
    CopySource, CopyTarget, CreateConnector, CreateFunction, CreateFunctionBody,
    CreateFunctionUsing, CreateIndex, CreatePolicyCommand, CreatePolicyType, CreateTable,
    CreateTableOptions, CreateViewAlgorithm, CreateViewParams, CreateViewSecurity, Cte,
    CteAsMaterialized, DataType, DateTimeField, Declare, DeclareAssignment, DeclareType,
    Deduplicate, DeferrableInitial, Delete, DescribeAlias, DictionaryField, DiscardObject,
    Distinct, DoUpdate, DollarQuotedString, DropBehavior, DuplicateTreatment, EmptyMatchesMode,
    EnumMember, ExactNumberInfo, ExceptSelectItem, ExcludeSelectItem, Expr, ExprWithAlias,
    ExtractSyntax, Fetch, FetchDirection, FileFormat, FlushLocation, FlushType, ForClause, ForXml,
    FormatClause, FromTable, Function, FunctionArg, FunctionArgExpr, FunctionArgumentClause,
    FunctionArgumentList, FunctionArguments, FunctionBehavior, FunctionCalledOnNull, FunctionDesc,
    FunctionDeterminismSpecifier, FunctionParallel, GeneratedAs, GeneratedExpressionMode,
    GeometricTypeKind, GrantObjects, Grantee, GranteeName, GranteesType, GroupByExpr,
    GroupByWithModifier, HavingBound, HavingBoundKind, HiveDelimiter, HiveDescribeFormat,
    HiveDistributionStyle, HiveFormat, HiveLoadDataFormat, HiveRowDelimiter, HiveRowFormat,
    HiveSetLocation, Ident, IdentWithAlias, IdentityParameters, IdentityProperty,
    IdentityPropertyFormatKind, IdentityPropertyKind, IdentityPropertyOrder, IfStatement,
    IlikeSelectItem, IndexColumn, IndexOption, IndexType, InputFormatClause, Insert, InsertAliases,
    Interpolate, InterpolateExpr, Interval, Join, JoinConstraint, JoinOperator, JsonNullClause,
    JsonPath, JsonPathElem, KeyOrIndexDisplay, KeyValueOptions, KillType, LambdaFunction,
    LateralView, LimitClause, ListAggOnOverflow, LockClause, LockTable, LockTableType, LockType,
    MacroArg, MacroDefinition, Map, MapEntry, MatchRecognizePattern, MatchRecognizeSymbol, Measure,
    MergeAction, MergeClause, MergeClauseKind, MergeInsertExpr, MergeInsertKind, Method,
    MinMaxValue, MySQLColumnPosition, MysqlInsertPriority, NamedWindowDefinition, NamedWindowExpr,
    NonBlock, NullTreatment, NullsDistinctOption, ObjectName, ObjectNamePart, ObjectType, Offset,
    OffsetRows, OnCommit, OnConflict, OnConflictAction, OneOrManyWithParens, OperateFunctionArg,
    OrderBy, OrderByExpr, OrderByKind, OrderByOptions, OutputClause, Owner, Partition,
    PartitionRangeDirection, Password, PivotValueSource, Privileges, ProcedureParam,
    ProjectionSelect, Query, RaisErrorOption, RaiseStatement, RaiseStatementValue,
    ReferentialAction, RenameSelectItem, RenameTable, RepetitionQuantifier, ReplaceSelectElement,
    ReplaceSelectItem, ResetConfig, RoleOption, RowAccessPolicy, RowsPerMatch, SchemaName,
    SearchModifier, SecondaryRoles, SecretOption, Select, SelectFlavor, SelectInto, SelectItem,
    SelectItemQualifiedWildcardKind, SequenceOptions, SessionParamStatsTopic, SessionParamValue,
    Set, SetAssignment, SetConfigValue, SetExpr, SetOperator, SetQuantifier,
    SetSessionParamGeneric, SetSessionParamIdentityInsert, SetSessionParamKind,
    SetSessionParamOffsets, SetSessionParamStatistics, Setting, ShowCreateObject, ShowObjects,
    ShowStatementFilter, ShowStatementFilterPosition, ShowStatementIn, ShowStatementInClause,
    ShowStatementInParentType, ShowStatementOptions, Span, SqlOption, SqliteOnConflict, Statement,
    StorageSerializationPolicy, StructBracketKind, StructField, Subscript, SymbolDefinition, Table,
    TableAlias, TableAliasColumnDef, TableConstraint, TableFactor, TableFunctionArgs,
    TableIndexHintForClause, TableIndexHintType, TableIndexHints, TableIndexType, TableObject,
    TableOptionsClustered, TableSample, TableSampleBucket, TableSampleMethod, TableSampleModifier,
    TableSampleQuantity, TableSampleSeed, TableSampleSeedModifier, TableSampleUnit, TableVersion,
    TableWithJoins, Tag, TagsColumnOption, TimezoneInfo, Token, Top, TopQuantity,
    TransactionAccessMode, TransactionIsolationLevel, TransactionMode, TransactionModifier,
    TriggerEvent, TriggerExecBody, TriggerExecBodyType, TriggerObject, TriggerPeriod,
    TriggerReferencing, TriggerReferencingType, TrimWhereField, TruncateIdentityOption,
    UnaryOperator, UnionField, UpdateTableFromKind, Use, UserDefinedTypeCompositeAttributeDef,
    UserDefinedTypeRepresentation, UtilityOption, ValueTableMode, ValueWithSpan, Values,
    ViewColumnDef, WildcardAdditionalOptions, WindowFrame, WindowFrameBound, WindowFrameUnits,
    WindowSpec, WindowType, With, WithFill, WrappedCollection,
};

use crate::ast::helpers::key_value_options::{KeyValueOption, KeyValueOptionKind};
use crate::ast::helpers::stmt_create_table::CreateTableBuilder;
use crate::ast::helpers::stmt_data_loading::{
    FileStagingCommand, StageLoadSelectItem, StageParamsObject,
};
use crate::tokenizer::{Location, TokenWithSpan, Whitespace, Word};
...
pub trait Visitor {
    ...
    fn pre_visit_after_match_skip(
        &mut self,
        _after_match_skip: &AfterMatchSkip,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any after match skip that appear in the AST after visiting children
    fn post_visit_after_match_skip(
        &mut self,
        _after_match_skip: &AfterMatchSkip,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_column_operation(
        &mut self,
        _alter_column_operation: &AlterColumnOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter column operation that appear in the AST after visiting children
    fn post_visit_alter_column_operation(
        &mut self,
        _alter_column_operation: &AlterColumnOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_connector_owner(
        &mut self,
        _alter_connector_owner: &AlterConnectorOwner,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter connector owner that appear in the AST after visiting children
    fn post_visit_alter_connector_owner(
        &mut self,
        _alter_connector_owner: &AlterConnectorOwner,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_index_operation(
        &mut self,
        _alter_index_operation: &AlterIndexOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter index operation that appear in the AST after visiting children
    fn post_visit_alter_index_operation(
        &mut self,
        _alter_index_operation: &AlterIndexOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_policy_operation(
        &mut self,
        _alter_policy_operation: &AlterPolicyOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter policy operation that appear in the AST after visiting children
    fn post_visit_alter_policy_operation(
        &mut self,
        _alter_policy_operation: &AlterPolicyOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_role_operation(
        &mut self,
        _alter_role_operation: &AlterRoleOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter role operation that appear in the AST after visiting children
    fn post_visit_alter_role_operation(
        &mut self,
        _alter_role_operation: &AlterRoleOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_table_algorithm(
        &mut self,
        _alter_table_algorithm: &AlterTableAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter table algorithm that appear in the AST after visiting children
    fn post_visit_alter_table_algorithm(
        &mut self,
        _alter_table_algorithm: &AlterTableAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_table_lock(
        &mut self,
        _alter_table_lock: &AlterTableLock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter table lock that appear in the AST after visiting children
    fn post_visit_alter_table_lock(
        &mut self,
        _alter_table_lock: &AlterTableLock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_table_operation(
        &mut self,
        _alter_table_operation: &AlterTableOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter table operation that appear in the AST after visiting children
    fn post_visit_alter_table_operation(
        &mut self,
        _alter_table_operation: &AlterTableOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_type_add_value(
        &mut self,
        _alter_type_add_value: &AlterTypeAddValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter type add value that appear in the AST after visiting children
    fn post_visit_alter_type_add_value(
        &mut self,
        _alter_type_add_value: &AlterTypeAddValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_type_add_value_position(
        &mut self,
        _alter_type_add_value_position: &AlterTypeAddValuePosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter type add value position that appear in the AST after visiting children
    fn post_visit_alter_type_add_value_position(
        &mut self,
        _alter_type_add_value_position: &AlterTypeAddValuePosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_type_operation(
        &mut self,
        _alter_type_operation: &AlterTypeOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter type operation that appear in the AST after visiting children
    fn post_visit_alter_type_operation(
        &mut self,
        _alter_type_operation: &AlterTypeOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_type_rename(
        &mut self,
        _alter_type_rename: &AlterTypeRename,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter type rename that appear in the AST after visiting children
    fn post_visit_alter_type_rename(
        &mut self,
        _alter_type_rename: &AlterTypeRename,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_alter_type_rename_value(
        &mut self,
        _alter_type_rename_value: &AlterTypeRenameValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any alter type rename value that appear in the AST after visiting children
    fn post_visit_alter_type_rename_value(
        &mut self,
        _alter_type_rename_value: &AlterTypeRenameValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_analyze_format(
        &mut self,
        _analyze_format: &AnalyzeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any analyze format that appear in the AST after visiting children
    fn post_visit_analyze_format(
        &mut self,
        _analyze_format: &AnalyzeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_array_elem_type_def(
        &mut self,
        _array_elem_type_def: &ArrayElemTypeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any array elem type def that appear in the AST after visiting children
    fn post_visit_array_elem_type_def(
        &mut self,
        _array_elem_type_def: &ArrayElemTypeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_assignment_target(
        &mut self,
        _assignment_target: &AssignmentTarget,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any assignment target that appear in the AST after visiting children
    fn post_visit_assignment_target(
        &mut self,
        _assignment_target: &AssignmentTarget,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_attach_duck_db_database_option(
        &mut self,
        _attach_duck_db_database_option: &AttachDuckDBDatabaseOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any attach duck db database option that appear in the AST after visiting children
    fn post_visit_attach_duck_db_database_option(
        &mut self,
        _attach_duck_db_database_option: &AttachDuckDBDatabaseOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_attached_token(
        &mut self,
        _attached_token: &AttachedToken,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any attached token that appear in the AST after visiting children
    fn post_visit_attached_token(
        &mut self,
        _attached_token: &AttachedToken,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_begin_transaction_kind(
        &mut self,
        _begin_transaction_kind: &BeginTransactionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any begin transaction kind that appear in the AST after visiting children
    fn post_visit_begin_transaction_kind(
        &mut self,
        _begin_transaction_kind: &BeginTransactionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_binary_length(
        &mut self,
        _binary_length: &BinaryLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any binary length that appear in the AST after visiting children
    fn post_visit_binary_length(
        &mut self,
        _binary_length: &BinaryLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_cascade_option(
        &mut self,
        _cascade_option: &CascadeOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any cascade option that appear in the AST after visiting children
    fn post_visit_cascade_option(
        &mut self,
        _cascade_option: &CascadeOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_case_statement(
        &mut self,
        _case_statement: &CaseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any case statement that appear in the AST after visiting children
    fn post_visit_case_statement(
        &mut self,
        _case_statement: &CaseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_ceil_floor_kind(
        &mut self,
        _ceil_floor_kind: &CeilFloorKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any ceil floor kind that appear in the AST after visiting children
    fn post_visit_ceil_floor_kind(
        &mut self,
        _ceil_floor_kind: &CeilFloorKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_char_length_units(
        &mut self,
        _char_length_units: &CharLengthUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any char length units that appear in the AST after visiting children
    fn post_visit_char_length_units(
        &mut self,
        _char_length_units: &CharLengthUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_character_length(
        &mut self,
        _character_length: &CharacterLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any character length that appear in the AST after visiting children
    fn post_visit_character_length(
        &mut self,
        _character_length: &CharacterLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_clustered_index(
        &mut self,
        _clustered_index: &ClusteredIndex,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any clustered index that appear in the AST after visiting children
    fn post_visit_clustered_index(
        &mut self,
        _clustered_index: &ClusteredIndex,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_column_option(
        &mut self,
        _column_option: &ColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any column option that appear in the AST after visiting children
    fn post_visit_column_option(
        &mut self,
        _column_option: &ColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_column_option_def(
        &mut self,
        _column_option_def: &ColumnOptionDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any column option def that appear in the AST after visiting children
    fn post_visit_column_option_def(
        &mut self,
        _column_option_def: &ColumnOptionDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_column_policy(
        &mut self,
        _column_policy: &ColumnPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any column policy that appear in the AST after visiting children
    fn post_visit_column_policy(
        &mut self,
        _column_policy: &ColumnPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_column_policy_property(
        &mut self,
        _column_policy_property: &ColumnPolicyProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any column policy property that appear in the AST after visiting children
    fn post_visit_column_policy_property(
        &mut self,
        _column_policy_property: &ColumnPolicyProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_comment_object(
        &mut self,
        _comment_object: &CommentObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any comment object that appear in the AST after visiting children
    fn post_visit_comment_object(
        &mut self,
        _comment_object: &CommentObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_conditional_statement_block(
        &mut self,
        _conditional_statement_block: &ConditionalStatementBlock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any conditional statement block that appear in the AST after visiting children
    fn post_visit_conditional_statement_block(
        &mut self,
        _conditional_statement_block: &ConditionalStatementBlock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_conditional_statements(
        &mut self,
        _conditional_statements: &ConditionalStatements,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any conditional statements that appear in the AST after visiting children
    fn post_visit_conditional_statements(
        &mut self,
        _conditional_statements: &ConditionalStatements,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any connect by kind that appear in the AST before visiting children
    fn pre_visit_connect_by_kind(
        &mut self,
        _connect_by_kind: &ConnectByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any connect by kind that appear in the AST after visiting children
    fn post_visit_connect_by_kind(
        &mut self,
        _connect_by_kind: &ConnectByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_constraint_characteristics(
        &mut self,
        _constraint_characteristics: &ConstraintCharacteristics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any constraint characteristics that appear in the AST after visiting children
    fn post_visit_constraint_characteristics(
        &mut self,
        _constraint_characteristics: &ConstraintCharacteristics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_context_modifier(
        &mut self,
        _context_modifier: &ContextModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any context modifier that appear in the AST after visiting children
    fn post_visit_context_modifier(
        &mut self,
        _context_modifier: &ContextModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_copy_into_snowflake_kind(
        &mut self,
        _copy_into_snowflake_kind: &CopyIntoSnowflakeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any copy into snowflake kind that appear in the AST after visiting children
    fn post_visit_copy_into_snowflake_kind(
        &mut self,
        _copy_into_snowflake_kind: &CopyIntoSnowflakeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_copy_legacy_csv_option(
        &mut self,
        _copy_legacy_csv_option: &CopyLegacyCsvOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any copy legacy csv option that appear in the AST after visiting children
    fn post_visit_copy_legacy_csv_option(
        &mut self,
        _copy_legacy_csv_option: &CopyLegacyCsvOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_copy_legacy_option(
        &mut self,
        _copy_legacy_option: &CopyLegacyOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any copy legacy option that appear in the AST after visiting children
    fn post_visit_copy_legacy_option(
        &mut self,
        _copy_legacy_option: &CopyLegacyOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_connector(
        &mut self,
        _create_connector: &CreateConnector,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create connector that appear in the AST after visiting children
    fn post_visit_create_connector(
        &mut self,
        _create_connector: &CreateConnector,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_function_body(
        &mut self,
        _create_function_body: &CreateFunctionBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create function body that appear in the AST after visiting children
    fn post_visit_create_function_body(
        &mut self,
        _create_function_body: &CreateFunctionBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_function_using(
        &mut self,
        _create_function_using: &CreateFunctionUsing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create function using that appear in the AST after visiting children
    fn post_visit_create_function_using(
        &mut self,
        _create_function_using: &CreateFunctionUsing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_policy_command(
        &mut self,
        _create_policy_command: &CreatePolicyCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create policy command that appear in the AST after visiting children
    fn post_visit_create_policy_command(
        &mut self,
        _create_policy_command: &CreatePolicyCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_policy_type(
        &mut self,
        _create_policy_type: &CreatePolicyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create policy type that appear in the AST after visiting children
    fn post_visit_create_policy_type(
        &mut self,
        _create_policy_type: &CreatePolicyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_table_builder(
        &mut self,
        _create_table_builder: &CreateTableBuilder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create table builder that appear in the AST after visiting children
    fn post_visit_create_table_builder(
        &mut self,
        _create_table_builder: &CreateTableBuilder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_table_options(
        &mut self,
        _create_table_options: &CreateTableOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create table options that appear in the AST after visiting children
    fn post_visit_create_table_options(
        &mut self,
        _create_table_options: &CreateTableOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_view_algorithm(
        &mut self,
        _create_view_algorithm: &CreateViewAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create view algorithm that appear in the AST after visiting children
    fn post_visit_create_view_algorithm(
        &mut self,
        _create_view_algorithm: &CreateViewAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_view_params(
        &mut self,
        _create_view_params: &CreateViewParams,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create view params that appear in the AST after visiting children
    fn post_visit_create_view_params(
        &mut self,
        _create_view_params: &CreateViewParams,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_create_view_security(
        &mut self,
        _create_view_security: &CreateViewSecurity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any create view security that appear in the AST after visiting children
    fn post_visit_create_view_security(
        &mut self,
        _create_view_security: &CreateViewSecurity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_cte_as_materialized(
        &mut self,
        _cte_as_materialized: &CteAsMaterialized,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any cte as materialized that appear in the AST after visiting children
    fn post_visit_cte_as_materialized(
        &mut self,
        _cte_as_materialized: &CteAsMaterialized,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_date_time_field(
        &mut self,
        _date_time_field: &DateTimeField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any date time field that appear in the AST after visiting children
    fn post_visit_date_time_field(
        &mut self,
        _date_time_field: &DateTimeField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_declare_assignment(
        &mut self,
        _declare_assignment: &DeclareAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any declare assignment that appear in the AST after visiting children
    fn post_visit_declare_assignment(
        &mut self,
        _declare_assignment: &DeclareAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_deferrable_initial(
        &mut self,
        _deferrable_initial: &DeferrableInitial,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any deferrable initial that appear in the AST after visiting children
    fn post_visit_deferrable_initial(
        &mut self,
        _deferrable_initial: &DeferrableInitial,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_describe_alias(
        &mut self,
        _describe_alias: &DescribeAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any describe alias that appear in the AST after visiting children
    fn post_visit_describe_alias(
        &mut self,
        _describe_alias: &DescribeAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_dictionary_field(
        &mut self,
        _dictionary_field: &DictionaryField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any dictionary field that appear in the AST after visiting children
    fn post_visit_dictionary_field(
        &mut self,
        _dictionary_field: &DictionaryField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_discard_object(
        &mut self,
        _discard_object: &DiscardObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any discard object that appear in the AST after visiting children
    fn post_visit_discard_object(
        &mut self,
        _discard_object: &DiscardObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_dollar_quoted_string(
        &mut self,
        _dollar_quoted_string: &DollarQuotedString,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any dollar quoted string that appear in the AST after visiting children
    fn post_visit_dollar_quoted_string(
        &mut self,
        _dollar_quoted_string: &DollarQuotedString,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_drop_behavior(
        &mut self,
        _drop_behavior: &DropBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any drop behavior that appear in the AST after visiting children
    fn post_visit_drop_behavior(
        &mut self,
        _drop_behavior: &DropBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_duplicate_treatment(
        &mut self,
        _duplicate_treatment: &DuplicateTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any duplicate treatment that appear in the AST after visiting children
    fn post_visit_duplicate_treatment(
        &mut self,
        _duplicate_treatment: &DuplicateTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_empty_matches_mode(
        &mut self,
        _empty_matches_mode: &EmptyMatchesMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any empty matches mode that appear in the AST after visiting children
    fn post_visit_empty_matches_mode(
        &mut self,
        _empty_matches_mode: &EmptyMatchesMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_exact_number_info(
        &mut self,
        _exact_number_info: &ExactNumberInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any exact number info that appear in the AST after visiting children
    fn post_visit_exact_number_info(
        &mut self,
        _exact_number_info: &ExactNumberInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_except_select_item(
        &mut self,
        _except_select_item: &ExceptSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any except select item that appear in the AST after visiting children
    fn post_visit_except_select_item(
        &mut self,
        _except_select_item: &ExceptSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_exclude_select_item(
        &mut self,
        _exclude_select_item: &ExcludeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any exclude select item that appear in the AST after visiting children
    fn post_visit_exclude_select_item(
        &mut self,
        _exclude_select_item: &ExcludeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_expr_with_alias(
        &mut self,
        _expr_with_alias: &ExprWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any expr with alias that appear in the AST after visiting children
    fn post_visit_expr_with_alias(
        &mut self,
        _expr_with_alias: &ExprWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_extract_syntax(
        &mut self,
        _extract_syntax: &ExtractSyntax,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any extract syntax that appear in the AST after visiting children
    fn post_visit_extract_syntax(
        &mut self,
        _extract_syntax: &ExtractSyntax,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_fetch_direction(
        &mut self,
        _fetch_direction: &FetchDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any fetch direction that appear in the AST after visiting children
    fn post_visit_fetch_direction(
        &mut self,
        _fetch_direction: &FetchDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_file_staging_command(
        &mut self,
        _file_staging_command: &FileStagingCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any file staging command that appear in the AST after visiting children
    fn post_visit_file_staging_command(
        &mut self,
        _file_staging_command: &FileStagingCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_flush_location(
        &mut self,
        _flush_location: &FlushLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any flush location that appear in the AST after visiting children
    fn post_visit_flush_location(
        &mut self,
        _flush_location: &FlushLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_format_clause(
        &mut self,
        _format_clause: &FormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any format clause that appear in the AST after visiting children
    fn post_visit_format_clause(
        &mut self,
        _format_clause: &FormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_arg_expr(
        &mut self,
        _function_arg_expr: &FunctionArgExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_argument_clause(
        &mut self,
        _function_argument_clause: &FunctionArgumentClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function argument clause that appear in the AST after visiting children
    fn post_visit_function_argument_clause(
        &mut self,
        _function_argument_clause: &FunctionArgumentClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_argument_list(
        &mut self,
        _function_argument_list: &FunctionArgumentList,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function argument list that appear in the AST after visiting children
    fn post_visit_function_argument_list(
        &mut self,
        _function_argument_list: &FunctionArgumentList,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_arguments(
        &mut self,
        _function_arguments: &FunctionArguments,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function arguments that appear in the AST after visiting children
    fn post_visit_function_arguments(
        &mut self,
        _function_arguments: &FunctionArguments,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_behavior(
        &mut self,
        _function_behavior: &FunctionBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function behavior that appear in the AST after visiting children
    fn post_visit_function_behavior(
        &mut self,
        _function_behavior: &FunctionBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_called_on_null(
        &mut self,
        _function_called_on_null: &FunctionCalledOnNull,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function called on null that appear in the AST after visiting children
    fn post_visit_function_called_on_null(
        &mut self,
        _function_called_on_null: &FunctionCalledOnNull,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_desc(
        &mut self,
        _function_desc: &FunctionDesc,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function desc that appear in the AST after visiting children
    fn post_visit_function_desc(
        &mut self,
        _function_desc: &FunctionDesc,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_determinism_specifier(
        &mut self,
        _function_determinism_specifier: &FunctionDeterminismSpecifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function determinism specifier that appear in the AST after visiting children
    fn post_visit_function_determinism_specifier(
        &mut self,
        _function_determinism_specifier: &FunctionDeterminismSpecifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_parallel(
        &mut self,
        _function_parallel: &FunctionParallel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function parallel that appear in the AST after visiting children
    fn post_visit_function_parallel(
        &mut self,
        _function_parallel: &FunctionParallel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_generated_expression_mode(
        &mut self,
        _generated_expression_mode: &GeneratedExpressionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any generated expression mode that appear in the AST after visiting children
    fn post_visit_generated_expression_mode(
        &mut self,
        _generated_expression_mode: &GeneratedExpressionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_geometric_type_kind(
        &mut self,
        _geometric_type_kind: &GeometricTypeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any geometric type kind that appear in the AST after visiting children
    fn post_visit_geometric_type_kind(
        &mut self,
        _geometric_type_kind: &GeometricTypeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_grant_objects(
        &mut self,
        _grant_objects: &GrantObjects,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any grant objects that appear in the AST after visiting children
    fn post_visit_grant_objects(
        &mut self,
        _grant_objects: &GrantObjects,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_grantees_type(
        &mut self,
        _grantees_type: &GranteesType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any grantees type that appear in the AST after visiting children
    fn post_visit_grantees_type(
        &mut self,
        _grantees_type: &GranteesType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_group_by_expr(
        &mut self,
        _group_by_expr: &GroupByExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_group_by_with_modifier(
        &mut self,
        _group_by_with_modifier: &GroupByWithModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any group by with modifier that appear in the AST after visiting children
    fn post_visit_group_by_with_modifier(
        &mut self,
        _group_by_with_modifier: &GroupByWithModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_having_bound_kind(
        &mut self,
        _having_bound_kind: &HavingBoundKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any having bound kind that appear in the AST after visiting children
    fn post_visit_having_bound_kind(
        &mut self,
        _having_bound_kind: &HavingBoundKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_delimiter(
        &mut self,
        _hive_delimiter: &HiveDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive delimiter that appear in the AST after visiting children
    fn post_visit_hive_delimiter(
        &mut self,
        _hive_delimiter: &HiveDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_describe_format(
        &mut self,
        _hive_describe_format: &HiveDescribeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive describe format that appear in the AST after visiting children
    fn post_visit_hive_describe_format(
        &mut self,
        _hive_describe_format: &HiveDescribeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_distribution_style(
        &mut self,
        _hive_distribution_style: &HiveDistributionStyle,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive distribution style that appear in the AST after visiting children
    fn post_visit_hive_distribution_style(
        &mut self,
        _hive_distribution_style: &HiveDistributionStyle,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_load_data_format(
        &mut self,
        _hive_load_data_format: &HiveLoadDataFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive load data format that appear in the AST after visiting children
    fn post_visit_hive_load_data_format(
        &mut self,
        _hive_load_data_format: &HiveLoadDataFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_row_delimiter(
        &mut self,
        _hive_row_delimiter: &HiveRowDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive row delimiter that appear in the AST after visiting children
    fn post_visit_hive_row_delimiter(
        &mut self,
        _hive_row_delimiter: &HiveRowDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_row_format(
        &mut self,
        _hive_row_format: &HiveRowFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive row format that appear in the AST after visiting children
    fn post_visit_hive_row_format(
        &mut self,
        _hive_row_format: &HiveRowFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_hive_set_location(
        &mut self,
        _hive_set_location: &HiveSetLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any hive set location that appear in the AST after visiting children
    fn post_visit_hive_set_location(
        &mut self,
        _hive_set_location: &HiveSetLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_ident_with_alias(
        &mut self,
        _ident_with_alias: &IdentWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any ident with alias that appear in the AST after visiting children
    fn post_visit_ident_with_alias(
        &mut self,
        _ident_with_alias: &IdentWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_identity_parameters(
        &mut self,
        _identity_parameters: &IdentityParameters,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any identity parameters that appear in the AST after visiting children
    fn post_visit_identity_parameters(
        &mut self,
        _identity_parameters: &IdentityParameters,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_identity_property(
        &mut self,
        _identity_property: &IdentityProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any identity property that appear in the AST after visiting children
    fn post_visit_identity_property(
        &mut self,
        _identity_property: &IdentityProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_identity_property_format_kind(
        &mut self,
        _identity_property_format_kind: &IdentityPropertyFormatKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any identity property format kind that appear in the AST after visiting children
    fn post_visit_identity_property_format_kind(
        &mut self,
        _identity_property_format_kind: &IdentityPropertyFormatKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_identity_property_kind(
        &mut self,
        _identity_property_kind: &IdentityPropertyKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any identity property kind that appear in the AST after visiting children
    fn post_visit_identity_property_kind(
        &mut self,
        _identity_property_kind: &IdentityPropertyKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_identity_property_order(
        &mut self,
        _identity_property_order: &IdentityPropertyOrder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any identity property order that appear in the AST after visiting children
    fn post_visit_identity_property_order(
        &mut self,
        _identity_property_order: &IdentityPropertyOrder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_ilike_select_item(
        &mut self,
        _ilike_select_item: &IlikeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any ilike select item that appear in the AST after visiting children
    fn post_visit_ilike_select_item(
        &mut self,
        _ilike_select_item: &IlikeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_input_format_clause(
        &mut self,
        _input_format_clause: &InputFormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any input format clause that appear in the AST after visiting children
    fn post_visit_input_format_clause(
        &mut self,
        _input_format_clause: &InputFormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_insert_aliases(
        &mut self,
        _insert_aliases: &InsertAliases,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any insert aliases that appear in the AST after visiting children
    fn post_visit_insert_aliases(
        &mut self,
        _insert_aliases: &InsertAliases,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_interpolate_expr(
        &mut self,
        _interpolate_expr: &InterpolateExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any interpolate expr that appear in the AST after visiting children
    fn post_visit_interpolate_expr(
        &mut self,
        _interpolate_expr: &InterpolateExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_join_constraint(
        &mut self,
        _join_constraint: &JoinConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any join constraint that appear in the AST after visiting children
    fn post_visit_join_constraint(
        &mut self,
        _join_constraint: &JoinConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_join_operator(
        &mut self,
        _join_operator: &JoinOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any join operator that appear in the AST after visiting children
    fn post_visit_join_operator(
        &mut self,
        _join_operator: &JoinOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_json_null_clause(
        &mut self,
        _json_null_clause: &JsonNullClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any json null clause that appear in the AST after visiting children
    fn post_visit_json_null_clause(
        &mut self,
        _json_null_clause: &JsonNullClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_json_path_elem(
        &mut self,
        _json_path_elem: &JsonPathElem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any json path elem that appear in the AST after visiting children
    fn post_visit_json_path_elem(
        &mut self,
        _json_path_elem: &JsonPathElem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_key_or_index_display(
        &mut self,
        _key_or_index_display: &KeyOrIndexDisplay,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any key or index display that appear in the AST after visiting children
    fn post_visit_key_or_index_display(
        &mut self,
        _key_or_index_display: &KeyOrIndexDisplay,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_key_value_option(
        &mut self,
        _key_value_option: &KeyValueOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any key value option that appear in the AST after visiting children
    fn post_visit_key_value_option(
        &mut self,
        _key_value_option: &KeyValueOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_key_value_option_kind(
        &mut self,
        _key_value_option_kind: &KeyValueOptionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any key value option type that appear in the AST after visiting children
    fn post_visit_key_value_option_kind(
        &mut self,
        _key_value_option_kind: &KeyValueOptionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_key_value_options(
        &mut self,
        _key_value_options: &KeyValueOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any key value options that appear in the AST after visiting children
    fn post_visit_key_value_options(
        &mut self,
        _key_value_options: &KeyValueOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_list_agg_on_overflow(
        &mut self,
        _list_agg_on_overflow: &ListAggOnOverflow,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any list agg on overflow that appear in the AST after visiting children
    fn post_visit_list_agg_on_overflow(
        &mut self,
        _list_agg_on_overflow: &ListAggOnOverflow,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_lock_table_type(
        &mut self,
        _lock_table_type: &LockTableType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any lock table type that appear in the AST after visiting children
    fn post_visit_lock_table_type(
        &mut self,
        _lock_table_type: &LockTableType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_macro_definition(
        &mut self,
        _macro_definition: &MacroDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any macro definition that appear in the AST after visiting children
    fn post_visit_macro_definition(
        &mut self,
        _macro_definition: &MacroDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_match_recognize_pattern(
        &mut self,
        _match_recognize_pattern: &MatchRecognizePattern,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any match recognize pattern that appear in the AST after visiting children
    fn post_visit_match_recognize_pattern(
        &mut self,
        _match_recognize_pattern: &MatchRecognizePattern,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_match_recognize_symbol(
        &mut self,
        _match_recognize_symbol: &MatchRecognizeSymbol,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any match recognize symbol that appear in the AST after visiting children
    fn post_visit_match_recognize_symbol(
        &mut self,
        _match_recognize_symbol: &MatchRecognizeSymbol,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_merge_clause_kind(
        &mut self,
        _merge_clause_kind: &MergeClauseKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any merge clause kind that appear in the AST after visiting children
    fn post_visit_merge_clause_kind(
        &mut self,
        _merge_clause_kind: &MergeClauseKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_merge_insert_expr(
        &mut self,
        _merge_insert_expr: &MergeInsertExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any merge insert expr that appear in the AST after visiting children
    fn post_visit_merge_insert_expr(
        &mut self,
        _merge_insert_expr: &MergeInsertExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_merge_insert_kind(
        &mut self,
        _merge_insert_kind: &MergeInsertKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any merge insert kind that appear in the AST after visiting children
    fn post_visit_merge_insert_kind(
        &mut self,
        _merge_insert_kind: &MergeInsertKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_min_max_value(
        &mut self,
        _min_max_value: &MinMaxValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any min max value that appear in the AST after visiting children
    fn post_visit_min_max_value(
        &mut self,
        _min_max_value: &MinMaxValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_my_sql_column_position(
        &mut self,
        _my_sql_column_position: &MySQLColumnPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any my sql column position that appear in the AST after visiting children
    fn post_visit_my_sql_column_position(
        &mut self,
        _my_sql_column_position: &MySQLColumnPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_mysql_insert_priority(
        &mut self,
        _mysql_insert_priority: &MysqlInsertPriority,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any mysql insert priority that appear in the AST after visiting children
    fn post_visit_mysql_insert_priority(
        &mut self,
        _mysql_insert_priority: &MysqlInsertPriority,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_named_window_definition(
        &mut self,
        _named_window_definition: &NamedWindowDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any named window definition that appear in the AST after visiting children
    fn post_visit_named_window_definition(
        &mut self,
        _named_window_definition: &NamedWindowDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_named_window_expr(
        &mut self,
        _named_window_expr: &NamedWindowExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any named window expr that appear in the AST after visiting children
    fn post_visit_named_window_expr(
        &mut self,
        _named_window_expr: &NamedWindowExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_null_treatment(
        &mut self,
        _null_treatment: &NullTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any null treatment that appear in the AST after visiting children
    fn post_visit_null_treatment(
        &mut self,
        _null_treatment: &NullTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_nulls_distinct_option(
        &mut self,
        _nulls_distinct_option: &NullsDistinctOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any nulls distinct option that appear in the AST after visiting children
    fn post_visit_nulls_distinct_option(
        &mut self,
        _nulls_distinct_option: &NullsDistinctOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_object_name_part(
        &mut self,
        _object_name_part: &ObjectNamePart,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any object name part that appear in the AST after visiting children
    fn post_visit_object_name_part(
        &mut self,
        _object_name_part: &ObjectNamePart,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_on_conflict_action(
        &mut self,
    ...
    fn post_visit_on_conflict_action(
        &mut self,
        _on_conflict_action: &OnConflictAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_one_or_many_with_parens<T: Visit>(
        &mut self,
        _one_or_many_with_parens: &OneOrManyWithParens<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any one or many with parens that appear in the AST after visiting children
    fn post_visit_one_or_many_with_parens<T: Visit>(
        &mut self,
        _one_or_many_with_parens: &OneOrManyWithParens<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_operate_function_arg(
        &mut self,
        _operate_function_arg: &OperateFunctionArg,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any operate function arg that appear in the AST after visiting children
    fn post_visit_operate_function_arg(
        &mut self,
        _operate_function_arg: &OperateFunctionArg,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_order_by_kind(
        &mut self,
        _order_by_kind: &OrderByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any order by kind that appear in the AST after visiting children
    fn post_visit_order_by_kind(
        &mut self,
        _order_by_kind: &OrderByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_order_by_options(
        &mut self,
        _order_by_options: &OrderByOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any order by options that appear in the AST after visiting children
    fn post_visit_order_by_options(
        &mut self,
        _order_by_options: &OrderByOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_output_clause(
        &mut self,
        _output_clause: &OutputClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any output clause that appear in the AST after visiting children
    fn post_visit_output_clause(
        &mut self,
        _output_clause: &OutputClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_partition_range_direction(
        &mut self,
        _partition_range_direction: &PartitionRangeDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any partition range direction that appear in the AST after visiting children
    fn post_visit_partition_range_direction(
        &mut self,
        _partition_range_direction: &PartitionRangeDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_pivot_value_source(
        &mut self,
        _pivot_value_source: &PivotValueSource,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any pivot value source that appear in the AST after visiting children
    fn post_visit_pivot_value_source(
        &mut self,
        _pivot_value_source: &PivotValueSource,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_procedure_param(
        &mut self,
        _procedure_param: &ProcedureParam,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any procedure param that appear in the AST after visiting children
    fn post_visit_procedure_param(
        &mut self,
        _procedure_param: &ProcedureParam,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_projection_select(
        &mut self,
        _projection_select: &ProjectionSelect,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any projection select that appear in the AST after visiting children
    fn post_visit_projection_select(
        &mut self,
        _projection_select: &ProjectionSelect,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_rais_error_option(
        &mut self,
        _rais_error_option: &RaisErrorOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any rais error option that appear in the AST after visiting children
    fn post_visit_rais_error_option(
        &mut self,
        _rais_error_option: &RaisErrorOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_raise_statement(
        &mut self,
        _raise_statement: &RaiseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any raise statement that appear in the AST after visiting children
    fn post_visit_raise_statement(
        &mut self,
        _raise_statement: &RaiseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_raise_statement_value(
        &mut self,
        _raise_statement_value: &RaiseStatementValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any raise statement value that appear in the AST after visiting children
    fn post_visit_raise_statement_value(
        &mut self,
        _raise_statement_value: &RaiseStatementValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_referential_action(
        &mut self,
        _referential_action: &ReferentialAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any referential action that appear in the AST after visiting children
    fn post_visit_referential_action(
        &mut self,
        _referential_action: &ReferentialAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_rename_select_item(
        &mut self,
        _rename_select_item: &RenameSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any rename select item that appear in the AST after visiting children
    fn post_visit_rename_select_item(
        &mut self,
        _rename_select_item: &RenameSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_repetition_quantifier(
        &mut self,
        _repetition_quantifier: &RepetitionQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any repetition quantifier that appear in the AST after visiting children
    fn post_visit_repetition_quantifier(
        &mut self,
        _repetition_quantifier: &RepetitionQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_replace_select_element(
        &mut self,
        _replace_select_element: &ReplaceSelectElement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any replace select element that appear in the AST after visiting children
    fn post_visit_replace_select_element(
        &mut self,
        _replace_select_element: &ReplaceSelectElement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_replace_select_item(
        &mut self,
        _replace_select_item: &ReplaceSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any replace select item that appear in the AST after visiting children
    fn post_visit_replace_select_item(
        &mut self,
        _replace_select_item: &ReplaceSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_row_access_policy(
        &mut self,
        _row_access_policy: &RowAccessPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any row access policy that appear in the AST after visiting children
    fn post_visit_row_access_policy(
        &mut self,
        _row_access_policy: &RowAccessPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_rows_per_match(
        &mut self,
        _rows_per_match: &RowsPerMatch,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any rows per match that appear in the AST after visiting children
    fn post_visit_rows_per_match(
        &mut self,
        _rows_per_match: &RowsPerMatch,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_search_modifier(
        &mut self,
        _search_modifier: &SearchModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any search modifier that appear in the AST after visiting children
    fn post_visit_search_modifier(
        &mut self,
        _search_modifier: &SearchModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_secondary_roles(
        &mut self,
        _secondary_roles: &SecondaryRoles,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any secondary roles that appear in the AST after visiting children
    fn post_visit_secondary_roles(
        &mut self,
        _secondary_roles: &SecondaryRoles,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_secret_option(
        &mut self,
        _secret_option: &SecretOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any secret option that appear in the AST after visiting children
    fn post_visit_secret_option(
        &mut self,
        _secret_option: &SecretOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_select_flavor(
        &mut self,
        _select_flavor: &SelectFlavor,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any select flavor that appear in the AST after visiting children
    fn post_visit_select_flavor(
        &mut self,
        _select_flavor: &SelectFlavor,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_select_item_qualified_wildcard_kind(
        &mut self,
        _select_item_qualified_wildcard_kind: &SelectItemQualifiedWildcardKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any select item qualified wildcard kind that appear in the AST after visiting children
    fn post_visit_select_item_qualified_wildcard_kind(
        &mut self,
        _select_item_qualified_wildcard_kind: &SelectItemQualifiedWildcardKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_sequence_options(
        &mut self,
        _sequence_options: &SequenceOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any sequence options that appear in the AST after visiting children
    fn post_visit_sequence_options(
        &mut self,
        _sequence_options: &SequenceOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_session_param_stats_topic(
        &mut self,
        _session_param_stats_topic: &SessionParamStatsTopic,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any session param stats topic that appear in the AST after visiting children
    fn post_visit_session_param_stats_topic(
        &mut self,
        _session_param_stats_topic: &SessionParamStatsTopic,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_session_param_value(
        &mut self,
        _session_param_value: &SessionParamValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any session param value that appear in the AST after visiting children
    fn post_visit_session_param_value(
        &mut self,
        _session_param_value: &SessionParamValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_assignment(
        &mut self,
        _set_assignment: &SetAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set assignment that appear in the AST after visiting children
    fn post_visit_set_assignment(
        &mut self,
        _set_assignment: &SetAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_config_value(
        &mut self,
        _set_config_value: &SetConfigValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set config value that appear in the AST after visiting children
    fn post_visit_set_config_value(
        &mut self,
        _set_config_value: &SetConfigValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_quantifier(
        &mut self,
        _set_quantifier: &SetQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set quantifier that appear in the AST after visiting children
    fn post_visit_set_quantifier(
        &mut self,
        _set_quantifier: &SetQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_session_param_generic(
        &mut self,
        _set_session_param_generic: &SetSessionParamGeneric,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set session param generic that appear in the AST after visiting children
    fn post_visit_set_session_param_generic(
        &mut self,
        _set_session_param_generic: &SetSessionParamGeneric,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_session_param_identity_insert(
        &mut self,
        _set_session_param_identity_insert: &SetSessionParamIdentityInsert,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set session param identity insert that appear in the AST after visiting children
    fn post_visit_set_session_param_identity_insert(
        &mut self,
        _set_session_param_identity_insert: &SetSessionParamIdentityInsert,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_session_param_kind(
        &mut self,
        _set_session_param_kind: &SetSessionParamKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set session param kind that appear in the AST after visiting children
    fn post_visit_set_session_param_kind(
        &mut self,
        _set_session_param_kind: &SetSessionParamKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_session_param_offsets(
        &mut self,
        _set_session_param_offsets: &SetSessionParamOffsets,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set session param offsets that appear in the AST after visiting children
    fn post_visit_set_session_param_offsets(
        &mut self,
        _set_session_param_offsets: &SetSessionParamOffsets,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_session_param_statistics(
        &mut self,
        _set_session_param_statistics: &SetSessionParamStatistics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set session param statistics that appear in the AST after visiting children
    fn post_visit_set_session_param_statistics(
        &mut self,
        _set_session_param_statistics: &SetSessionParamStatistics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_create_object(
        &mut self,
        _show_create_object: &ShowCreateObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show create object that appear in the AST after visiting children
    fn post_visit_show_create_object(
        &mut self,
        _show_create_object: &ShowCreateObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_filter(
        &mut self,
        _show_statement_filter: &ShowStatementFilter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement filter that appear in the AST after visiting children
    fn post_visit_show_statement_filter(
        &mut self,
        _show_statement_filter: &ShowStatementFilter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_filter_position(
        &mut self,
        _show_statement_filter_position: &ShowStatementFilterPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement filter position that appear in the AST after visiting children
    fn post_visit_show_statement_filter_position(
        &mut self,
        _show_statement_filter_position: &ShowStatementFilterPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_in(
        &mut self,
        _show_statement_in: &ShowStatementIn,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement in that appear in the AST after visiting children
    fn post_visit_show_statement_in(
        &mut self,
        _show_statement_in: &ShowStatementIn,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_in_clause(
        &mut self,
        _show_statement_in_clause: &ShowStatementInClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement in clause that appear in the AST after visiting children
    fn post_visit_show_statement_in_clause(
        &mut self,
        _show_statement_in_clause: &ShowStatementInClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_in_parent_type(
        &mut self,
        _show_statement_in_parent_type: &ShowStatementInParentType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement in parent type that appear in the AST after visiting children
    fn post_visit_show_statement_in_parent_type(
        &mut self,
        _show_statement_in_parent_type: &ShowStatementInParentType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_options(
        &mut self,
        _show_statement_options: &ShowStatementOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show statement options that appear in the AST after visiting children
    fn post_visit_show_statement_options(
        &mut self,
        _show_statement_options: &ShowStatementOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_sqlite_on_conflict(
        &mut self,
        _sqlite_on_conflict: &SqliteOnConflict,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any sqlite on conflict that appear in the AST after visiting children
    fn post_visit_sqlite_on_conflict(
        &mut self,
        _sqlite_on_conflict: &SqliteOnConflict,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_stage_load_select_item(
        &mut self,
        _stage_load_select_item: &StageLoadSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any stage load select item that appear in the AST after visiting children
    fn post_visit_stage_load_select_item(
        &mut self,
        _stage_load_select_item: &StageLoadSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_stage_params_object(
        &mut self,
        _stage_params_object: &StageParamsObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any stage params object that appear in the AST after visiting children
    fn post_visit_stage_params_object(
        &mut self,
        _stage_params_object: &StageParamsObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_storage_serialization_policy(
        &mut self,
        _storage_serialization_policy: &StorageSerializationPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any storage serialization policy that appear in the AST after visiting children
    fn post_visit_storage_serialization_policy(
        &mut self,
        _storage_serialization_policy: &StorageSerializationPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_struct_bracket_kind(
        &mut self,
        _struct_bracket_kind: &StructBracketKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any struct bracket kind that appear in the AST after visiting children
    fn post_visit_struct_bracket_kind(
        &mut self,
        _struct_bracket_kind: &StructBracketKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_symbol_definition(
        &mut self,
        _symbol_definition: &SymbolDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any symbol definition that appear in the AST after visiting children
    fn post_visit_symbol_definition(
        &mut self,
        _symbol_definition: &SymbolDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_alias_column_def(
        &mut self,
        _table_alias_column_def: &TableAliasColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table alias column def that appear in the AST after visiting children
    fn post_visit_table_alias_column_def(
        &mut self,
        _table_alias_column_def: &TableAliasColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_constraint(
        &mut self,
        _table_constraint: &TableConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table constraint that appear in the AST after visiting children
    fn post_visit_table_constraint(
        &mut self,
        _table_constraint: &TableConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_function_args(
        &mut self,
        _table_function_args: &TableFunctionArgs,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table function args that appear in the AST after visiting children
    fn post_visit_table_function_args(
        &mut self,
        _table_function_args: &TableFunctionArgs,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_index_hint_for_clause(
        &mut self,
        _table_index_hint_for_clause: &TableIndexHintForClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table index hint for clause that appear in the AST after visiting children
    fn post_visit_table_index_hint_for_clause(
        &mut self,
        _table_index_hint_for_clause: &TableIndexHintForClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_index_hint_type(
        &mut self,
        _table_index_hint_type: &TableIndexHintType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table index hint type that appear in the AST after visiting children
    fn post_visit_table_index_hint_type(
        &mut self,
        _table_index_hint_type: &TableIndexHintType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_index_hints(
        &mut self,
        _table_index_hints: &TableIndexHints,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table index hints that appear in the AST after visiting children
    fn post_visit_table_index_hints(
        &mut self,
        _table_index_hints: &TableIndexHints,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_index_type(
        &mut self,
        _table_index_type: &TableIndexType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table index type that appear in the AST after visiting children
    fn post_visit_table_index_type(
        &mut self,
        _table_index_type: &TableIndexType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_options_clustered(
        &mut self,
        _table_options_clustered: &TableOptionsClustered,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table options clustered that appear in the AST after visiting children
    fn post_visit_table_options_clustered(
        &mut self,
        _table_options_clustered: &TableOptionsClustered,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_bucket(
        &mut self,
        _table_sample_bucket: &TableSampleBucket,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample bucket that appear in the AST after visiting children
    fn post_visit_table_sample_bucket(
        &mut self,
        _table_sample_bucket: &TableSampleBucket,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_method(
        &mut self,
        _table_sample_method: &TableSampleMethod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample method that appear in the AST after visiting children
    fn post_visit_table_sample_method(
        &mut self,
        _table_sample_method: &TableSampleMethod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_modifier(
        &mut self,
        _table_sample_modifier: &TableSampleModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample modifier that appear in the AST after visiting children
    fn post_visit_table_sample_modifier(
        &mut self,
        _table_sample_modifier: &TableSampleModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_quantity(
        &mut self,
        _table_sample_quantity: &TableSampleQuantity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample quantity that appear in the AST after visiting children
    fn post_visit_table_sample_quantity(
        &mut self,
        _table_sample_quantity: &TableSampleQuantity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_seed(
        &mut self,
        _table_sample_seed: &TableSampleSeed,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample seed that appear in the AST after visiting children
    fn post_visit_table_sample_seed(
        &mut self,
        _table_sample_seed: &TableSampleSeed,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_seed_modifier(
        &mut self,
        _table_sample_seed_modifier: &TableSampleSeedModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample seed modifier that appear in the AST after visiting children
    fn post_visit_table_sample_seed_modifier(
        &mut self,
        _table_sample_seed_modifier: &TableSampleSeedModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_unit(
        &mut self,
        _table_sample_unit: &TableSampleUnit,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample unit that appear in the AST after visiting children
    fn post_visit_table_sample_unit(
        &mut self,
        _table_sample_unit: &TableSampleUnit,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_version(
        &mut self,
        _table_version: &TableVersion,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table version that appear in the AST after visiting children
    fn post_visit_table_version(
        &mut self,
        _table_version: &TableVersion,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_with_joins(
        &mut self,
        _table_with_joins: &TableWithJoins,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_tags_column_option(
        &mut self,
        _tags_column_option: &TagsColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any tags column option that appear in the AST after visiting children
    fn post_visit_tags_column_option(
        &mut self,
        _tags_column_option: &TagsColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_timezone_info(
        &mut self,
        _timezone_info: &TimezoneInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any timezone info that appear in the AST after visiting children
    fn post_visit_timezone_info(
        &mut self,
        _timezone_info: &TimezoneInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_token_with_span(
        &mut self,
        _token_with_span: &TokenWithSpan,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any token with span that appear in the AST after visiting children
    fn post_visit_token_with_span(
        &mut self,
        _token_with_span: &TokenWithSpan,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_transaction_access_mode(
        &mut self,
        _transaction_access_mode: &TransactionAccessMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any transaction access mode that appear in the AST after visiting children
    fn post_visit_transaction_access_mode(
        &mut self,
        _transaction_access_mode: &TransactionAccessMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_transaction_isolation_level(
        &mut self,
        _transaction_isolation_level: &TransactionIsolationLevel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any transaction isolation level that appear in the AST after visiting children
    fn post_visit_transaction_isolation_level(
        &mut self,
        _transaction_isolation_level: &TransactionIsolationLevel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_transaction_mode(
        &mut self,
        _transaction_mode: &TransactionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any transaction mode that appear in the AST after visiting children
    fn post_visit_transaction_mode(
        &mut self,
        _transaction_mode: &TransactionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_transaction_modifier(
        &mut self,
        _transaction_modifier: &TransactionModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any transaction modifier that appear in the AST after visiting children
    fn post_visit_transaction_modifier(
        &mut self,
        _transaction_modifier: &TransactionModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_exec_body(
        &mut self,
        _trigger_exec_body: &TriggerExecBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger exec body that appear in the AST after visiting children
    fn post_visit_trigger_exec_body(
        &mut self,
        _trigger_exec_body: &TriggerExecBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_exec_body_type(
        &mut self,
        _trigger_exec_body_type: &TriggerExecBodyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger exec body type that appear in the AST after visiting children
    fn post_visit_trigger_exec_body_type(
        &mut self,
        _trigger_exec_body_type: &TriggerExecBodyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_object(
        &mut self,
        _trigger_object: &TriggerObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger object that appear in the AST after visiting children
    fn post_visit_trigger_object(
        &mut self,
        _trigger_object: &TriggerObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_period(
        &mut self,
        _trigger_period: &TriggerPeriod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger period that appear in the AST after visiting children
    fn post_visit_trigger_period(
        &mut self,
        _trigger_period: &TriggerPeriod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_referencing(
        &mut self,
        _trigger_referencing: &TriggerReferencing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger referencing that appear in the AST after visiting children
    fn post_visit_trigger_referencing(
        &mut self,
        _trigger_referencing: &TriggerReferencing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trigger_referencing_type(
        &mut self,
        _trigger_referencing_type: &TriggerReferencingType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trigger referencing type that appear in the AST after visiting children
    fn post_visit_trigger_referencing_type(
        &mut self,
        _trigger_referencing_type: &TriggerReferencingType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_trim_where_field(
        &mut self,
        _trim_where_field: &TrimWhereField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any trim where field that appear in the AST after visiting children
    fn post_visit_trim_where_field(
        &mut self,
        _trim_where_field: &TrimWhereField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_truncate_identity_option(
        &mut self,
        _truncate_identity_option: &TruncateIdentityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any truncate identity option that appear in the AST after visiting children
    fn post_visit_truncate_identity_option(
        &mut self,
        _truncate_identity_option: &TruncateIdentityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_unary_operator(
        &mut self,
        _unary_operator: &UnaryOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any unary operator that appear in the AST after visiting children
    fn post_visit_unary_operator(
        &mut self,
        _unary_operator: &UnaryOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_update_table_from_kind(
        &mut self,
        _update_table_from_kind: &UpdateTableFromKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any update table from kind that appear in the AST after visiting children
    fn post_visit_update_table_from_kind(
        &mut self,
        _update_table_from_kind: &UpdateTableFromKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_user_defined_type_composite_attribute_def(
        &mut self,
        _user_defined_type_composite_attribute_def: &UserDefinedTypeCompositeAttributeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any user defined type composite attribute def that appear in the AST after visiting children
    fn post_visit_user_defined_type_composite_attribute_def(
        &mut self,
        _user_defined_type_composite_attribute_def: &UserDefinedTypeCompositeAttributeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_user_defined_type_representation(
        &mut self,
        _user_defined_type_representation: &UserDefinedTypeRepresentation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any user defined type representation that appear in the AST after visiting children
    fn post_visit_user_defined_type_representation(
        &mut self,
        _user_defined_type_representation: &UserDefinedTypeRepresentation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_utility_option(
        &mut self,
        _utility_option: &UtilityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any utility option that appear in the AST after visiting children
    fn post_visit_utility_option(
        &mut self,
        _utility_option: &UtilityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_value_table_mode(
        &mut self,
        _value_table_mode: &ValueTableMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any value table mode that appear in the AST after visiting children
    fn post_visit_value_table_mode(
        &mut self,
        _value_table_mode: &ValueTableMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_value_with_span(
        &mut self,
        _value_with_span: &ValueWithSpan,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_view_column_def(
        &mut self,
        _view_column_def: &ViewColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any view column def that appear in the AST after visiting children
    fn post_visit_view_column_def(
        &mut self,
        _view_column_def: &ViewColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_wildcard_additional_options(
        &mut self,
        _wildcard_additional_options: &WildcardAdditionalOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_window_frame_bound(
        &mut self,
        _window_frame_bound: &WindowFrameBound,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any window frame bound that appear in the AST after visiting children
    fn post_visit_window_frame_bound(
        &mut self,
        _window_frame_bound: &WindowFrameBound,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_window_frame_units(
        &mut self,
        _window_frame_units: &WindowFrameUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any window frame units that appear in the AST after visiting children
    fn post_visit_window_frame_units(
        &mut self,
        _window_frame_units: &WindowFrameUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_wrapped_collection<T: Visit>(
        &mut self,
        _wrapped_collection: &WrappedCollection<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any wrapped collection that appear in the AST after visiting children
    fn post_visit_wrapped_collection<T: Visit>(
        &mut self,
        _wrapped_collection: &WrappedCollection<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
...
pub trait VisitorMut {
    ...
    /// Invoked for any access expr that appear in the AST after visiting children
    fn post_visit_access_expr(
        &mut self,
        _access_expr: &mut AccessExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_add_drop_sync(
        &mut self,
        _add_drop_sync: &mut AddDropSync,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_after_match_skip(
        &mut self,
        _after_match_skip: &mut AfterMatchSkip,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_column_operation(
        &mut self,
        _alter_column_operation: &mut AlterColumnOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_connector_owner(
        &mut self,
        _alter_connector_owner: &mut AlterConnectorOwner,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_index_operation(
        &mut self,
        _alter_index_operation: &mut AlterIndexOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_policy_operation(
        &mut self,
        _alter_policy_operation: &mut AlterPolicyOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_role_operation(
        &mut self,
        _alter_role_operation: &mut AlterRoleOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_table_algorithm(
        &mut self,
        _alter_table_algorithm: &mut AlterTableAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_table_lock(
        &mut self,
        _alter_table_lock: &mut AlterTableLock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_table_operation(
        &mut self,
        _alter_table_operation: &mut AlterTableOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_type_add_value(
        &mut self,
        _alter_type_add_value: &mut AlterTypeAddValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_type_add_value_position(
        &mut self,
        _alter_type_add_value_position: &mut AlterTypeAddValuePosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_type_operation(
        &mut self,
        _alter_type_operation: &mut AlterTypeOperation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_type_rename(
        &mut self,
        _alter_type_rename: &mut AlterTypeRename,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_alter_type_rename_value(
        &mut self,
        _alter_type_rename_value: &mut AlterTypeRenameValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_analyze_format(
        &mut self,
        _analyze_format: &mut AnalyzeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_array_elem_type_def(
        &mut self,
        _array_elem_type_def: &mut ArrayElemTypeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_assignment_target(
        &mut self,
        _assignment_target: &mut AssignmentTarget,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_attach_duck_db_database_option(
        &mut self,
        _attach_duck_db_database_option: &mut AttachDuckDBDatabaseOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_attached_token(
        &mut self,
        _attached_token: &mut AttachedToken,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_begin_transaction_kind(
        &mut self,
        _begin_transaction_kind: &mut BeginTransactionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_binary_length(
        &mut self,
        _binary_length: &mut BinaryLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_cascade_option(
        &mut self,
        _cascade_option: &mut CascadeOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_case_statement(
        &mut self,
        _case_statement: &mut CaseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any cast format that appear in the AST after visiting children
    fn post_visit_cast_format(
        &mut self,
        _cast_format: &mut CastFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_ceil_floor_kind(
        &mut self,
        _ceil_floor_kind: &mut CeilFloorKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_char_length_units(
        &mut self,
        _char_length_units: &mut CharLengthUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_character_length(
        &mut self,
        _character_length: &mut CharacterLength,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any close cursor that appear in the AST before visiting children
    fn pre_visit_close_cursor(
        &mut self,
        _close_cursor: &mut CloseCursor,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any close cursor that appear in the AST after visiting children
    fn post_visit_close_cursor(
        &mut self,
        _close_cursor: &mut CloseCursor,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any clustered by that appear in the AST before visiting children
    fn pre_visit_clustered_by(
        &mut self,
        _clustered_by: &mut ClusteredBy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any clustered by that appear in the AST after visiting children
    fn post_visit_clustered_by(
        &mut self,
        _clustered_by: &mut ClusteredBy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_clustered_index(
        &mut self,
        _clustered_index: &mut ClusteredIndex,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_column_option(
        &mut self,
        _column_option: &mut ColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_column_option_def(
        &mut self,
        _column_option_def: &mut ColumnOptionDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_column_policy(
        &mut self,
        _column_policy: &mut ColumnPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_column_policy_property(
        &mut self,
        _column_policy_property: &mut ColumnPolicyProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any comment def that appear in the AST after visiting children
    fn post_visit_comment_def(
        &mut self,
        _comment_def: &mut CommentDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_comment_object(
        &mut self,
        _comment_object: &mut CommentObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_conditional_statement_block(
        &mut self,
        _conditional_statement_block: &mut ConditionalStatementBlock,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_conditional_statements(
        &mut self,
        _conditional_statements: &mut ConditionalStatements,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_conflict_target(
        &mut self,
        _conflict_target: &mut ConflictTarget,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_connect_by_kind(
        &mut self,
        _connect_by_kind: &mut ConnectByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_constraint_characteristics(
        &mut self,
        _constraint_characteristics: &mut ConstraintCharacteristics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_context_modifier(
        &mut self,
        _context_modifier: &mut ContextModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_copy_into_snowflake_kind(
        &mut self,
        _copy_into_snowflake_kind: &mut CopyIntoSnowflakeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_copy_legacy_csv_option(
        &mut self,
        _copy_legacy_csv_option: &mut CopyLegacyCsvOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_copy_legacy_option(
        &mut self,
        _copy_legacy_option: &mut CopyLegacyOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any copy option that appear in the AST after visiting children
    fn post_visit_copy_option(
        &mut self,
        _copy_option: &mut CopyOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any copy source that appear in the AST after visiting children
    fn post_visit_copy_source(
        &mut self,
        _copy_source: &mut CopySource,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any copy target that appear in the AST after visiting children
    fn post_visit_copy_target(
        &mut self,
        _copy_target: &mut CopyTarget,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_connector(
        &mut self,
        _create_connector: &mut CreateConnector,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_function(
        &mut self,
        _create_function: &mut CreateFunction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_function_body(
        &mut self,
        _create_function_body: &mut CreateFunctionBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_function_using(
        &mut self,
        _create_function_using: &mut CreateFunctionUsing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_policy_command(
        &mut self,
        _create_policy_command: &mut CreatePolicyCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_policy_type(
        &mut self,
        _create_policy_type: &mut CreatePolicyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_table_builder(
        &mut self,
        _create_table_builder: &mut CreateTableBuilder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_table_options(
        &mut self,
        _create_table_options: &mut CreateTableOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_view_algorithm(
        &mut self,
        _create_view_algorithm: &mut CreateViewAlgorithm,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_view_params(
        &mut self,
        _create_view_params: &mut CreateViewParams,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_create_view_security(
        &mut self,
        _create_view_security: &mut CreateViewSecurity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_cte_as_materialized(
        &mut self,
        _cte_as_materialized: &mut CteAsMaterialized,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_date_time_field(
        &mut self,
        _date_time_field: &mut DateTimeField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_declare_assignment(
        &mut self,
        _declare_assignment: &mut DeclareAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any declare type that appear in the AST before visiting children
    fn pre_visit_declare_type(
        &mut self,
        _declare_type: &mut DeclareType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any declare type that appear in the AST after visiting children
    fn post_visit_declare_type(
        &mut self,
        _declare_type: &mut DeclareType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any deduplicate that appear in the AST before visiting children
    fn pre_visit_deduplicate(
        &mut self,
        _deduplicate: &mut Deduplicate,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any deduplicate that appear in the AST after visiting children
    fn post_visit_deduplicate(
        &mut self,
        _deduplicate: &mut Deduplicate,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_deferrable_initial(
        &mut self,
        _deferrable_initial: &mut DeferrableInitial,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_describe_alias(
        &mut self,
        _describe_alias: &mut DescribeAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_dictionary_field(
        &mut self,
        _dictionary_field: &mut DictionaryField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_discard_object(
        &mut self,
        _discard_object: &mut DiscardObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_dollar_quoted_string(
        &mut self,
        _dollar_quoted_string: &mut DollarQuotedString,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_drop_behavior(
        &mut self,
        _drop_behavior: &mut DropBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_duplicate_treatment(
        &mut self,
        _duplicate_treatment: &mut DuplicateTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_empty_matches_mode(
        &mut self,
        _empty_matches_mode: &mut EmptyMatchesMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any enum member that appear in the AST after visiting children
    fn post_visit_enum_member(
        &mut self,
        _enum_member: &mut EnumMember,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_exact_number_info(
        &mut self,
        _exact_number_info: &mut ExactNumberInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_except_select_item(
        &mut self,
        _except_select_item: &mut ExceptSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_exclude_select_item(
        &mut self,
        _exclude_select_item: &mut ExcludeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_expr_with_alias(
        &mut self,
        _expr_with_alias: &mut ExprWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_extract_syntax(
        &mut self,
        _extract_syntax: &mut ExtractSyntax,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_fetch_direction(
        &mut self,
        _fetch_direction: &mut FetchDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any file format that appear in the AST after visiting children
    fn post_visit_file_format(
        &mut self,
        _file_format: &mut FileFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_file_staging_command(
        &mut self,
        _file_staging_command: &mut FileStagingCommand,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_flush_location(
        &mut self,
        _flush_location: &mut FlushLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_format_clause(
        &mut self,
        _format_clause: &mut FormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any function arg that appear in the AST before visiting children
    fn pre_visit_function_arg(
        &mut self,
        _function_arg: &mut FunctionArg,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any function arg that appear in the AST after visiting children
    fn post_visit_function_arg(
        &mut self,
        _function_arg: &mut FunctionArg,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_function_argument_clause(
        &mut self,
        _function_argument_clause: &mut FunctionArgumentClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_argument_list(
        &mut self,
        _function_argument_list: &mut FunctionArgumentList,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_arguments(
        &mut self,
        _function_arguments: &mut FunctionArguments,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_behavior(
        &mut self,
        _function_behavior: &mut FunctionBehavior,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_called_on_null(
        &mut self,
        _function_called_on_null: &mut FunctionCalledOnNull,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_desc(
        &mut self,
        _function_desc: &mut FunctionDesc,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_determinism_specifier(
        &mut self,
        _function_determinism_specifier: &mut FunctionDeterminismSpecifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_function_parallel(
        &mut self,
        _function_parallel: &mut FunctionParallel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any generated as that appear in the AST before visiting children
    fn pre_visit_generated_as(
        &mut self,
        _generated_as: &mut GeneratedAs,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any generated as that appear in the AST after visiting children
    fn post_visit_generated_as(
        &mut self,
        _generated_as: &mut GeneratedAs,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_generated_expression_mode(
        &mut self,
        _generated_expression_mode: &mut GeneratedExpressionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_geometric_type_kind(
        &mut self,
        _geometric_type_kind: &mut GeometricTypeKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_grant_objects(
        &mut self,
        _grant_objects: &mut GrantObjects,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any grantee name that appear in the AST before visiting children
    fn pre_visit_grantee_name(
        &mut self,
        _grantee_name: &mut GranteeName,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any grantee name that appear in the AST after visiting children
    fn post_visit_grantee_name(
        &mut self,
        _grantee_name: &mut GranteeName,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_grantees_type(
        &mut self,
        _grantees_type: &mut GranteesType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_group_by_expr(
        &mut self,
        _group_by_expr: &mut GroupByExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_group_by_with_modifier(
        &mut self,
        _group_by_with_modifier: &mut GroupByWithModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any having bound that appear in the AST before visiting children
    fn pre_visit_having_bound(
        &mut self,
        _having_bound: &mut HavingBound,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any having bound that appear in the AST after visiting children
    fn post_visit_having_bound(
        &mut self,
        _having_bound: &mut HavingBound,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_having_bound_kind(
        &mut self,
        _having_bound_kind: &mut HavingBoundKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_delimiter(
        &mut self,
        _hive_delimiter: &mut HiveDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_describe_format(
        &mut self,
        _hive_describe_format: &mut HiveDescribeFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_distribution_style(
        &mut self,
        _hive_distribution_style: &mut HiveDistributionStyle,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any hive format that appear in the AST after visiting children
    fn post_visit_hive_format(
        &mut self,
        _hive_format: &mut HiveFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_load_data_format(
        &mut self,
        _hive_load_data_format: &mut HiveLoadDataFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_row_delimiter(
        &mut self,
        _hive_row_delimiter: &mut HiveRowDelimiter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_row_format(
        &mut self,
        _hive_row_format: &mut HiveRowFormat,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_hive_set_location(
        &mut self,
        _hive_set_location: &mut HiveSetLocation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_ident_with_alias(
        &mut self,
        _ident_with_alias: &mut IdentWithAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_identity_parameters(
        &mut self,
        _identity_parameters: &mut IdentityParameters,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_identity_property(
        &mut self,
        _identity_property: &mut IdentityProperty,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_identity_property_format_kind(
        &mut self,
        _identity_property_format_kind: &mut IdentityPropertyFormatKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_identity_property_kind(
        &mut self,
        _identity_property_kind: &mut IdentityPropertyKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_identity_property_order(
        &mut self,
        _identity_property_order: &mut IdentityPropertyOrder,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any if statement that appear in the AST before visiting children
    fn pre_visit_if_statement(
        &mut self,
        _if_statement: &mut IfStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_ilike_select_item(
        &mut self,
        _ilike_select_item: &mut IlikeSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any index column that appear in the AST before visiting children
    fn pre_visit_index_column(
        &mut self,
        _index_column: &mut IndexColumn,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any index column that appear in the AST after visiting children
    fn post_visit_index_column(
        &mut self,
        _index_column: &mut IndexColumn,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any index option that appear in the AST before visiting children
    fn pre_visit_index_option(
        &mut self,
        _index_option: &mut IndexOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any index option that appear in the AST after visiting children
    fn post_visit_index_option(
        &mut self,
        _index_option: &mut IndexOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_input_format_clause(
        &mut self,
        _input_format_clause: &mut InputFormatClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_insert_aliases(
        &mut self,
        _insert_aliases: &mut InsertAliases,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any interpolate that appear in the AST before visiting children
    fn pre_visit_interpolate(
        &mut self,
        _interpolate: &mut Interpolate,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any interpolate that appear in the AST after visiting children
    fn post_visit_interpolate(
        &mut self,
        _interpolate: &mut Interpolate,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_interpolate_expr(
        &mut self,
        _interpolate_expr: &mut InterpolateExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_join_constraint(
        &mut self,
        _join_constraint: &mut JoinConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_join_operator(
        &mut self,
        _join_operator: &mut JoinOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_json_null_clause(
        &mut self,
        _json_null_clause: &mut JsonNullClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_json_path_elem(
        &mut self,
        _json_path_elem: &mut JsonPathElem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_key_or_index_display(
        &mut self,
        _key_or_index_display: &mut KeyOrIndexDisplay,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_key_value_option(
        &mut self,
        _key_value_option: &mut KeyValueOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_key_value_option_kind(
        &mut self,
        _key_value_option_kind: &mut KeyValueOptionKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_key_value_options(
        &mut self,
        _key_value_options: &mut KeyValueOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_lambda_function(
        &mut self,
        _lambda_function: &mut LambdaFunction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any lateral view that appear in the AST before visiting children
    fn pre_visit_lateral_view(
        &mut self,
        _lateral_view: &mut LateralView,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any lateral view that appear in the AST after visiting children
    fn post_visit_lateral_view(
        &mut self,
        _lateral_view: &mut LateralView,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_limit_clause(
        &mut self,
        _limit_clause: &mut LimitClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any limit clause that appear in the AST after visiting children
    fn post_visit_limit_clause(
        &mut self,
        _limit_clause: &mut LimitClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_list_agg_on_overflow(
        &mut self,
        _list_agg_on_overflow: &mut ListAggOnOverflow,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any lock clause that appear in the AST after visiting children
    fn post_visit_lock_clause(
        &mut self,
        _lock_clause: &mut LockClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_lock_table_type(
        &mut self,
        _lock_table_type: &mut LockTableType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_macro_definition(
        &mut self,
        _macro_definition: &mut MacroDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_match_recognize_pattern(
        &mut self,
        _match_recognize_pattern: &mut MatchRecognizePattern,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_match_recognize_symbol(
        &mut self,
        _match_recognize_symbol: &mut MatchRecognizeSymbol,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any merge action that appear in the AST before visiting children
    fn pre_visit_merge_action(
        &mut self,
        _merge_action: &mut MergeAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any merge action that appear in the AST after visiting children
    fn post_visit_merge_action(
        &mut self,
        _merge_action: &mut MergeAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any merge clause that appear in the AST before visiting children
    fn pre_visit_merge_clause(
        &mut self,
        _merge_clause: &mut MergeClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any merge clause that appear in the AST after visiting children
    fn post_visit_merge_clause(
        &mut self,
        _merge_clause: &mut MergeClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_merge_clause_kind(
        &mut self,
        _merge_clause_kind: &mut MergeClauseKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_merge_insert_expr(
        &mut self,
        _merge_insert_expr: &mut MergeInsertExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_merge_insert_kind(
        &mut self,
        _merge_insert_kind: &mut MergeInsertKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_min_max_value(
        &mut self,
        _min_max_value: &mut MinMaxValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_my_sql_column_position(
        &mut self,
        _my_sql_column_position: &mut MySQLColumnPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_mysql_insert_priority(
        &mut self,
        _mysql_insert_priority: &mut MysqlInsertPriority,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_named_window_definition(
        &mut self,
        _named_window_definition: &mut NamedWindowDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_named_window_expr(
        &mut self,
        _named_window_expr: &mut NamedWindowExpr,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_null_treatment(
        &mut self,
        _null_treatment: &mut NullTreatment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_nulls_distinct_option(
        &mut self,
        _nulls_distinct_option: &mut NullsDistinctOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_object_name_part(
        &mut self,
        _object_name_part: &mut ObjectNamePart,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any offset rows that appear in the AST after visiting children
    fn post_visit_offset_rows(
        &mut self,
        _offset_rows: &mut OffsetRows,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any on conflict that appear in the AST after visiting children
    fn post_visit_on_conflict(
        &mut self,
        _on_conflict: &mut OnConflict,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_on_conflict_action(
        &mut self,
        _on_conflict_action: &mut OnConflictAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any one or many with parens that appear in the AST before visiting children
    fn pre_visit_one_or_many_with_parens<T: VisitMut>(
        &mut self,
        _one_or_many_with_parens: &mut OneOrManyWithParens<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any one or many with parens that appear in the AST after visiting children
    fn post_visit_one_or_many_with_parens<T: VisitMut>(
        &mut self,
        _one_or_many_with_parens: &mut OneOrManyWithParens<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_operate_function_arg(
        &mut self,
        _operate_function_arg: &mut OperateFunctionArg,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_order_by_kind(
        &mut self,
        _order_by_kind: &mut OrderByKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_order_by_options(
        &mut self,
        _order_by_options: &mut OrderByOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_output_clause(
        &mut self,
        _output_clause: &mut OutputClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_partition_range_direction(
        &mut self,
        _partition_range_direction: &mut PartitionRangeDirection,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_pivot_value_source(
        &mut self,
        _pivot_value_source: &mut PivotValueSource,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_procedure_param(
        &mut self,
        _procedure_param: &mut ProcedureParam,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_projection_select(
        &mut self,
        _projection_select: &mut ProjectionSelect,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_rais_error_option(
        &mut self,
        _rais_error_option: &mut RaisErrorOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_raise_statement(
        &mut self,
        _raise_statement: &mut RaiseStatement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_raise_statement_value(
        &mut self,
        _raise_statement_value: &mut RaiseStatementValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_referential_action(
        &mut self,
        _referential_action: &mut ReferentialAction,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_rename_select_item(
        &mut self,
        _rename_select_item: &mut RenameSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any rename table that appear in the AST before visiting children
    fn pre_visit_rename_table(
        &mut self,
        _rename_table: &mut RenameTable,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any rename table that appear in the AST after visiting children
    fn post_visit_rename_table(
        &mut self,
        _rename_table: &mut RenameTable,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_repetition_quantifier(
        &mut self,
        _repetition_quantifier: &mut RepetitionQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_replace_select_element(
        &mut self,
        _replace_select_element: &mut ReplaceSelectElement,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_replace_select_item(
        &mut self,
        _replace_select_item: &mut ReplaceSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any reset config that appear in the AST before visiting children
    fn pre_visit_reset_config(
        &mut self,
        _reset_config: &mut ResetConfig,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any reset config that appear in the AST after visiting children
    fn post_visit_reset_config(
        &mut self,
        _reset_config: &mut ResetConfig,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    /// Invoked for any role option that appear in the AST after visiting children
    fn post_visit_role_option(
        &mut self,
        _role_option: &mut RoleOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_row_access_policy(
        &mut self,
        _row_access_policy: &mut RowAccessPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_rows_per_match(
        &mut self,
        _rows_per_match: &mut RowsPerMatch,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any schema name that appear in the AST after visiting children
    fn post_visit_schema_name(
        &mut self,
        _schema_name: &mut SchemaName,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_search_modifier(
        &mut self,
        _search_modifier: &mut SearchModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_secondary_roles(
        &mut self,
        _secondary_roles: &mut SecondaryRoles,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_secret_option(
        &mut self,
        _secret_option: &mut SecretOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_select_flavor(
        &mut self,
        _select_flavor: &mut SelectFlavor,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any select into that appear in the AST after visiting children
    fn post_visit_select_into(
        &mut self,
        _select_into: &mut SelectInto,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_select_item_qualified_wildcard_kind(
        &mut self,
        _select_item_qualified_wildcard_kind: &mut SelectItemQualifiedWildcardKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_sequence_options(
        &mut self,
        _sequence_options: &mut SequenceOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_session_param_stats_topic(
        &mut self,
        _session_param_stats_topic: &mut SessionParamStatsTopic,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_session_param_value(
        &mut self,
        _session_param_value: &mut SessionParamValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_assignment(
        &mut self,
        _set_assignment: &mut SetAssignment,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_config_value(
        &mut self,
        _set_config_value: &mut SetConfigValue,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any set operator that appear in the AST before visiting children
    fn pre_visit_set_operator(
        &mut self,
        _set_operator: &mut SetOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any set operator that appear in the AST after visiting children
    fn post_visit_set_operator(
        &mut self,
        _set_operator: &mut SetOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_set_quantifier(
        &mut self,
        _set_quantifier: &mut SetQuantifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_session_param_generic(
        &mut self,
        _set_session_param_generic: &mut SetSessionParamGeneric,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_session_param_identity_insert(
        &mut self,
        _set_session_param_identity_insert: &mut SetSessionParamIdentityInsert,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_session_param_kind(
        &mut self,
        _set_session_param_kind: &mut SetSessionParamKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_session_param_offsets(
        &mut self,
        _set_session_param_offsets: &mut SetSessionParamOffsets,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_set_session_param_statistics(
        &mut self,
        _set_session_param_statistics: &mut SetSessionParamStatistics,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_create_object(
        &mut self,
        _show_create_object: &mut ShowCreateObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any show objects that appear in the AST before visiting children
    fn pre_visit_show_objects(
        &mut self,
        _show_objects: &mut ShowObjects,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any show objects that appear in the AST after visiting children
    fn post_visit_show_objects(
        &mut self,
        _show_objects: &mut ShowObjects,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_show_statement_filter(
        &mut self,
        _show_statement_filter: &mut ShowStatementFilter,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_statement_filter_position(
        &mut self,
        _show_statement_filter_position: &mut ShowStatementFilterPosition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_statement_in(
        &mut self,
        _show_statement_in: &mut ShowStatementIn,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_statement_in_clause(
        &mut self,
        _show_statement_in_clause: &mut ShowStatementInClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_statement_in_parent_type(
        &mut self,
        _show_statement_in_parent_type: &mut ShowStatementInParentType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_show_statement_options(
        &mut self,
        _show_statement_options: &mut ShowStatementOptions,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_sqlite_on_conflict(
        &mut self,
        _sqlite_on_conflict: &mut SqliteOnConflict,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_stage_load_select_item(
        &mut self,
        _stage_load_select_item: &mut StageLoadSelectItem,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_stage_params_object(
        &mut self,
        _stage_params_object: &mut StageParamsObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_storage_serialization_policy(
        &mut self,
        _storage_serialization_policy: &mut StorageSerializationPolicy,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_struct_bracket_kind(
        &mut self,
        _struct_bracket_kind: &mut StructBracketKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any struct field that appear in the AST before visiting children
    fn pre_visit_struct_field(
        &mut self,
        _struct_field: &mut StructField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any struct field that appear in the AST after visiting children
    fn post_visit_struct_field(
        &mut self,
        _struct_field: &mut StructField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_symbol_definition(
        &mut self,
        _symbol_definition: &mut SymbolDefinition,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any table alias that appear in the AST after visiting children
    fn post_visit_table_alias(
        &mut self,
        _table_alias: &mut TableAlias,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_alias_column_def(
        &mut self,
        _table_alias_column_def: &mut TableAliasColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_constraint(
        &mut self,
        _table_constraint: &mut TableConstraint,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_function_args(
        &mut self,
        _table_function_args: &mut TableFunctionArgs,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_index_hint_for_clause(
        &mut self,
        _table_index_hint_for_clause: &mut TableIndexHintForClause,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_index_hint_type(
        &mut self,
        _table_index_hint_type: &mut TableIndexHintType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_index_hints(
        &mut self,
        _table_index_hints: &mut TableIndexHints,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_index_type(
        &mut self,
        _table_index_type: &mut TableIndexType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any table object that appear in the AST before visiting children
    fn pre_visit_table_object(
        &mut self,
        _table_object: &mut TableObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table object that appear in the AST after visiting children
    fn post_visit_table_object(
        &mut self,
        _table_object: &mut TableObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_options_clustered(
        &mut self,
        _table_options_clustered: &mut TableOptionsClustered,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any table sample that appear in the AST before visiting children
    fn pre_visit_table_sample(
        &mut self,
        _table_sample: &mut TableSample,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any table sample that appear in the AST after visiting children
    fn post_visit_table_sample(
        &mut self,
        _table_sample: &mut TableSample,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_table_sample_bucket(
        &mut self,
        _table_sample_bucket: &mut TableSampleBucket,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_method(
        &mut self,
        _table_sample_method: &mut TableSampleMethod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_modifier(
        &mut self,
        _table_sample_modifier: &mut TableSampleModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_quantity(
        &mut self,
        _table_sample_quantity: &mut TableSampleQuantity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_seed(
        &mut self,
        _table_sample_seed: &mut TableSampleSeed,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_seed_modifier(
        &mut self,
        _table_sample_seed_modifier: &mut TableSampleSeedModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_sample_unit(
        &mut self,
        _table_sample_unit: &mut TableSampleUnit,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_table_version(
        &mut self,
        _table_version: &mut TableVersion,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_tags_column_option(
        &mut self,
        _tags_column_option: &mut TagsColumnOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_timezone_info(
        &mut self,
        _timezone_info: &mut TimezoneInfo,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_token_with_span(
        &mut self,
        _token_with_span: &mut TokenWithSpan,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any top quantity that appear in the AST before visiting children
    fn pre_visit_top_quantity(
        &mut self,
        _top_quantity: &mut TopQuantity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any top quantity that appear in the AST after visiting children
    fn post_visit_top_quantity(
        &mut self,
        _top_quantity: &mut TopQuantity,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_transaction_access_mode(
        &mut self,
        _transaction_access_mode: &mut TransactionAccessMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_transaction_isolation_level(
        &mut self,
        _transaction_isolation_level: &mut TransactionIsolationLevel,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_transaction_mode(
        &mut self,
        _transaction_mode: &mut TransactionMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_transaction_modifier(
        &mut self,
        _transaction_modifier: &mut TransactionModifier,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_event(
        &mut self,
        _trigger_event: &mut TriggerEvent,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_exec_body(
        &mut self,
        _trigger_exec_body: &mut TriggerExecBody,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_exec_body_type(
        &mut self,
        _trigger_exec_body_type: &mut TriggerExecBodyType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_object(
        &mut self,
        _trigger_object: &mut TriggerObject,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_period(
        &mut self,
        _trigger_period: &mut TriggerPeriod,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_referencing(
        &mut self,
        _trigger_referencing: &mut TriggerReferencing,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trigger_referencing_type(
        &mut self,
        _trigger_referencing_type: &mut TriggerReferencingType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_trim_where_field(
        &mut self,
        _trim_where_field: &mut TrimWhereField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_truncate_identity_option(
        &mut self,
        _truncate_identity_option: &mut TruncateIdentityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_unary_operator(
        &mut self,
        _unary_operator: &mut UnaryOperator,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any union field that appear in the AST after visiting children
    fn post_visit_union_field(
        &mut self,
        _union_field: &mut UnionField,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_update_table_from_kind(
        &mut self,
        _update_table_from_kind: &mut UpdateTableFromKind,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_user_defined_type_composite_attribute_def(
        &mut self,
        _user_defined_type_composite_attribute_def: &mut UserDefinedTypeCompositeAttributeDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_user_defined_type_representation(
        &mut self,
        _user_defined_type_representation: &mut UserDefinedTypeRepresentation,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_utility_option(
        &mut self,
        _utility_option: &mut UtilityOption,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_value_table_mode(
        &mut self,
        _value_table_mode: &mut ValueTableMode,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_value_with_span(
        &mut self,
        _value_with_span: &mut ValueWithSpan,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_view_column_def(
        &mut self,
        _view_column_def: &mut ViewColumnDef,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any window frame that appear in the AST before visiting children
    fn pre_visit_window_frame(
        &mut self,
        _window_frame: &mut WindowFrame,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any window frame that appear in the AST after visiting children
    fn post_visit_window_frame(
        &mut self,
        _window_frame: &mut WindowFrame,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    ...
    fn pre_visit_window_frame_bound(
        &mut self,
        _window_frame_bound: &mut WindowFrameBound,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    fn pre_visit_window_frame_units(
        &mut self,
        _window_frame_units: &mut WindowFrameUnits,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any window spec that appear in the AST after visiting children
    fn post_visit_window_spec(
        &mut self,
        _window_spec: &mut WindowSpec,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any window type that appear in the AST after visiting children
    fn post_visit_window_type(
        &mut self,
        _window_type: &mut WindowType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
    ...
    /// Invoked for any wrapped collection that appear in the AST before visiting children
    fn pre_visit_wrapped_collection<T: VisitMut>(
        &mut self,
        _wrapped_collection: &mut WrappedCollection<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any wrapped collection that appear in the AST after visiting children
    fn post_visit_wrapped_collection<T: VisitMut>(
        &mut self,
        _wrapped_collection: &mut WrappedCollection<T>,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
