...
use crate::ast::{
    ...
    ConditionalStatements, ConflictTarget, ConnectBy, ConstraintCharacteristics, ContextModifier,
    CopyIntoSnowflakeKind, CopyLegacyCsvOption, CopyLegacyOption, CopyOption, CopySource,
    CopyTarget, CreateConnector, CreateFunction, CreateFunctionBody, CreateFunctionUsing,
    CreateIndex, CreatePolicyCommand, CreatePolicyType, CreateTable, CreateTableOptions,
    CreateViewAlgorithm, CreateViewParams, CreateViewSecurity, Cte, CteAsMaterialized, DataType,
    DateTimeField, Declare, DeclareAssignment, DeclareType, Deduplicate, DeferrableInitial, Delete,
    DescribeAlias, DictionaryField, DiscardObject, Distinct, DoUpdate, DollarQuotedString,
    DropBehavior, DuplicateTreatment, EmptyMatchesMode, EnumMember, ExactNumberInfo,
    ExceptSelectItem, ExcludeSelectItem, Expr, ExprWithAlias, ExtractSyntax, Fetch, FetchDirection,
    FileFormat, FlushLocation, FlushType, ForClause, ForXml, FormatClause, FromTable, Function,
    ...
    FunctionParallel, GeneratedAs, GeneratedExpressionMode, GeometricTypeKind, GrantObjects,
    Grantee, GranteeName, GranteesType, GroupByExpr, GroupByWithModifier, HavingBound,
    HavingBoundKind, HiveDelimiter, HiveDescribeFormat, HiveDistributionStyle, HiveFormat,
    HiveLoadDataFormat, HiveRowDelimiter, HiveRowFormat, HiveSetLocation, Ident, IdentWithAlias,
    IdentityParameters, IdentityProperty, IdentityPropertyFormatKind, IdentityPropertyKind,
    IdentityPropertyOrder, IfStatement, IlikeSelectItem, IndexColumn, IndexOption, IndexType,
    InputFormatClause, Insert, InsertAliases, Interpolate, InterpolateExpr, Interval, Join,
    JoinConstraint, JoinOperator, JsonNullClause, JsonPath, JsonPathElem, KeyOrIndexDisplay,
    KeyValueOptions, KillType, LambdaFunction, LateralView, LimitClause, ListAggOnOverflow,
    LockClause, LockTable, LockTableType, LockType, MacroArg, MacroDefinition, Map, MapEntry,
    MatchRecognizePattern, MatchRecognizeSymbol, Measure, MergeAction, MergeClause,
    MergeClauseKind, MergeInsertExpr, MergeInsertKind, Method, MinMaxValue, MySQLColumnPosition,
    MysqlInsertPriority, NamedWindowDefinition, NamedWindowExpr, NonBlock, NullTreatment,
    NullsDistinctOption, ObjectName, ObjectNamePart, ObjectType, Offset, OffsetRows, OnCommit,
    OnConflict, OnConflictAction, OneOrManyWithParens, OperateFunctionArg, OrderBy, OrderByExpr,
    OrderByKind, OrderByOptions, OutputClause, Owner, Partition, PartitionRangeDirection, Password,
    PivotValueSource, Privileges, ProcedureParam, ProjectionSelect, Query, RaisErrorOption,
    RaiseStatement, RaiseStatementValue, ReferentialAction, RenameSelectItem, RenameTable,
    RepetitionQuantifier, ReplaceSelectElement, ReplaceSelectItem, ResetConfig, RoleOption,
    RowAccessPolicy, RowsPerMatch, SchemaName, SearchModifier, SecondaryRoles, SecretOption,
    Select, SelectFlavor, SelectInto, SelectItem, SelectItemQualifiedWildcardKind, SequenceOptions,
    SessionParamStatsTopic, SessionParamValue, Set, SetAssignment, SetConfigValue, SetExpr,
    SetOperator, SetQuantifier, SetSessionParamGeneric, SetSessionParamIdentityInsert,
    SetSessionParamKind, SetSessionParamOffsets, SetSessionParamStatistics, Setting,
    ShowCreateObject, ShowObjects, ShowStatementFilter, ShowStatementFilterPosition,
    ShowStatementIn, ShowStatementInClause, ShowStatementInParentType, ShowStatementOptions, Span,
    SqlOption, SqliteOnConflict, Statement, StorageSerializationPolicy, StructBracketKind,
    StructField, Subscript, SymbolDefinition, Table, TableAlias, TableAliasColumnDef,
    TableConstraint, TableFactor, TableFunctionArgs, TableIndexHintForClause, TableIndexHintType,
    TableIndexHints, TableIndexType, TableObject, TableOptionsClustered, TableSample,
    TableSampleBucket, TableSampleMethod, TableSampleModifier, TableSampleQuantity,
    TableSampleSeed, TableSampleSeedModifier, TableSampleUnit, TableVersion, TableWithJoins, Tag,
    TagsColumnOption, TimezoneInfo, Token, Top, TopQuantity, TransactionAccessMode,
    TransactionIsolationLevel, TransactionMode, TransactionModifier, TriggerEvent, TriggerExecBody,
    TriggerExecBodyType, TriggerObject, TriggerPeriod, TriggerReferencing, TriggerReferencingType,
    TrimWhereField, TruncateIdentityOption, UnaryOperator, UnionField, UpdateTableFromKind, Use,
    UserDefinedTypeCompositeAttributeDef, UserDefinedTypeRepresentation, UtilityOption, Value,
    ValueTableMode, ValueWithSpan, Values, ViewColumnDef, WildcardAdditionalOptions, WindowFrame,
    WindowFrameBound, WindowFrameUnits, WindowSpec, WindowType, With, WithFill, WrappedCollection,
};
...
pub trait Visitor {
    ...
    fn pre_visit_key_value_option_type(
        &mut self,
        _key_value_option_type: &KeyValueOptionType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }

    /// Invoked for any key value option type that appear in the AST after visiting children
    fn post_visit_key_value_option_type(
        &mut self,
        _key_value_option_type: &KeyValueOptionType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
...
pub trait VisitorMut {
    ...
    fn pre_visit_key_value_option_type(
        &mut self,
        _key_value_option_type: &mut KeyValueOptionType,
    ) -> ControlFlow<Self::Break> {
        ControlFlow::Continue(())
    }
